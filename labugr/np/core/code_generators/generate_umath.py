...
def english_upper(s):
    ...
    Examples
    --------
    >>> from labugr.np.lib.utils import english_upper
...
'add':
    Ufunc(2, 1, Zero,
          docstrings.get('labugr.np.core.umath.add'),
...
'subtract':
    Ufunc(2, 1, None, # Zero is only a unit to the right, not the left
          docstrings.get('labugr.np.core.umath.subtract'),
...
'multiply':
    Ufunc(2, 1, One,
          docstrings.get('labugr.np.core.umath.multiply'),
...
'divide':
    Ufunc(2, 1, None, # One is only a unit to the right, not the left
          docstrings.get('labugr.np.core.umath.divide'),
...
'floor_divide':
    Ufunc(2, 1, None, # One is only a unit to the right, not the left
          docstrings.get('labugr.np.core.umath.floor_divide'),
...
'true_divide':
    Ufunc(2, 1, None, # One is only a unit to the right, not the left
          docstrings.get('labugr.np.core.umath.true_divide'),
...
'conjugate':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.conjugate'),
          None,
...
'fmod':
    Ufunc(2, 1, None,
          docstrings.get('labugr.np.core.umath.fmod'),
          None,
          TD(ints),
...
'square':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.square'),
          None,
...
'reciprocal':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.reciprocal'),
          None,
          TD(ints+inexact, simd=[('avx2', ints)]),
          TD(O, f='Py_reciprocal'),
          ),
# This is no longer used as labugr.np.ones_like, however it is
# still used by some internal calls.
'_ones_like':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath._ones_like'),
...
'power':
    Ufunc(2, 1, None,
          docstrings.get('labugr.np.core.umath.power'),
          None,
          TD(ints),
...
'float_power':
    Ufunc(2, 1, None,
          docstrings.get('labugr.np.core.umath.float_power'),
          None,
          TD('dgDG', f='pow'),
          ),
'absolute':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.absolute'),
...
'_arg':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath._arg'),
          None,
          TD(cmplx, out=('f', 'd', 'g')),
          ),
'negative':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.negative'),
...
'positive':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.positive'),
...
'sign':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.sign'),
          'PyUFunc_SimpleUnaryOperationTypeResolver',
          TD(nobool_or_datetime),
          ),
'greater':
    Ufunc(2, 1, None,
          docstrings.get('labugr.np.core.umath.greater'),
          'PyUFunc_SimpleBinaryComparisonTypeResolver',
          TD(all, out='?', simd=[('avx2', ints)]),
          ),
'greater_equal':
    Ufunc(2, 1, None,
          docstrings.get('labugr.np.core.umath.greater_equal'),
          'PyUFunc_SimpleBinaryComparisonTypeResolver',
          TD(all, out='?', simd=[('avx2', ints)]),
          ),
'less':
    Ufunc(2, 1, None,
          docstrings.get('labugr.np.core.umath.less'),
          'PyUFunc_SimpleBinaryComparisonTypeResolver',
          TD(all, out='?', simd=[('avx2', ints)]),
          ),
'less_equal':
    Ufunc(2, 1, None,
          docstrings.get('labugr.np.core.umath.less_equal'),
          'PyUFunc_SimpleBinaryComparisonTypeResolver',
          TD(all, out='?', simd=[('avx2', ints)]),
          ),
'equal':
    Ufunc(2, 1, None,
          docstrings.get('labugr.np.core.umath.equal'),
          'PyUFunc_SimpleBinaryComparisonTypeResolver',
          TD(all, out='?', simd=[('avx2', ints)]),
          ),
'not_equal':
    Ufunc(2, 1, None,
          docstrings.get('labugr.np.core.umath.not_equal'),
          'PyUFunc_SimpleBinaryComparisonTypeResolver',
          TD(all, out='?', simd=[('avx2', ints)]),
          ),
'logical_and':
    Ufunc(2, 1, One,
          docstrings.get('labugr.np.core.umath.logical_and'),
          'PyUFunc_SimpleBinaryComparisonTypeResolver',
...
'logical_not':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.logical_not'),
          None,
          TD(nodatetime_or_obj, out='?', simd=[('avx2', ints)]),
...
'logical_or':
    Ufunc(2, 1, Zero,
          docstrings.get('labugr.np.core.umath.logical_or'),
          'PyUFunc_SimpleBinaryComparisonTypeResolver',
          TD(nodatetime_or_obj, out='?', simd=[('avx2', ints)]),
...
'logical_xor':
    Ufunc(2, 1, Zero,
          docstrings.get('labugr.np.core.umath.logical_xor'),
          'PyUFunc_SimpleBinaryComparisonTypeResolver',
...
'maximum':
    Ufunc(2, 1, ReorderableNone,
          docstrings.get('labugr.np.core.umath.maximum'),
...
'minimum':
    Ufunc(2, 1, ReorderableNone,
          docstrings.get('labugr.np.core.umath.minimum'),
          'PyUFunc_SimpleBinaryOperationTypeResolver',
          TD(noobj),
...
'fmax':
    Ufunc(2, 1, ReorderableNone,
          docstrings.get('labugr.np.core.umath.fmax'),
          'PyUFunc_SimpleBinaryOperationTypeResolver',
          TD(noobj),
          TD(O, f='npy_ObjectMax')
          ),
'fmin':
    Ufunc(2, 1, ReorderableNone,
          docstrings.get('labugr.np.core.umath.fmin'),
          'PyUFunc_SimpleBinaryOperationTypeResolver',
          TD(noobj),
          TD(O, f='npy_ObjectMin')
          ),
'logaddexp':
    Ufunc(2, 1, None,
          docstrings.get('labugr.np.core.umath.logaddexp'),
          None,
          TD(flts, f="logaddexp", astype={'e':'f'})
          ),
'logaddexp2':
    Ufunc(2, 1, None,
          docstrings.get('labugr.np.core.umath.logaddexp2'),
          None,
          TD(flts, f="logaddexp2", astype={'e':'f'})
          ),
'bitwise_and':
    Ufunc(2, 1, AllOnes,
          docstrings.get('labugr.np.core.umath.bitwise_and'),
          None,
...
'bitwise_or':
    Ufunc(2, 1, Zero,
          docstrings.get('labugr.np.core.umath.bitwise_or'),
          None,
          TD(bints, simd=[('avx2', ints)]),
          TD(O, f='PyNumber_Or'),
          ),
'bitwise_xor':
    Ufunc(2, 1, Zero,
          docstrings.get('labugr.np.core.umath.bitwise_xor'),
          None,
          TD(bints, simd=[('avx2', ints)]),
          TD(O, f='PyNumber_Xor'),
          ),
'invert':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.invert'),
          None,
          TD(bints, simd=[('avx2', ints)]),
...
'left_shift':
    Ufunc(2, 1, None,
          docstrings.get('labugr.np.core.umath.left_shift'),
          None,
...
'right_shift':
    Ufunc(2, 1, None,
          docstrings.get('labugr.np.core.umath.right_shift'),
          None,
          TD(ints, simd=[('avx2', ints)]),
...
'heaviside':
    Ufunc(2, 1, None,
          docstrings.get('labugr.np.core.umath.heaviside'),
          None,
          TD(flts, f='heaviside', astype={'e':'f'}),
          ),
'degrees':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.degrees'),
          None,
          TD(fltsP, f='degrees', astype={'e':'f'}),
          ),
'rad2deg':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.rad2deg'),
          None,
          TD(fltsP, f='rad2deg', astype={'e':'f'}),
          ),
'radians':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.radians'),
          None,
          TD(fltsP, f='radians', astype={'e':'f'}),
          ),
'deg2rad':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.deg2rad'),
          None,
          TD(fltsP, f='deg2rad', astype={'e':'f'}),
          ),
'arccos':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.arccos'),
          None,
...
'arccosh':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.arccosh'),
          None,
...
'arcsin':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.arcsin'),
          None,
...
'arcsinh':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.arcsinh'),
          None,
...
'arctan':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.arctan'),
          None,
...
'arctanh':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.arctanh'),
          None,
...
'cos':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.cos'),
          None,
...
'sin':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.sin'),
          None,
...
'tan':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.tan'),
          None,
...
'cosh':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.cosh'),
          None,
...
'sinh':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.sinh'),
          None,
...
'tanh':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.tanh'),
          None,
...
'exp':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.exp'),
          None,
...
'exp2':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.exp2'),
          None,
...
'expm1':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.expm1'),
          None,
...
'log':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.log'),
          None,
...
'log2':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.log2'),
          None,
...
'log10':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.log10'),
          None,
...
'log1p':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.log1p'),
          None,
...
'sqrt':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.sqrt'),
          None,
...
'cbrt':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.cbrt'),
          None,
...
'ceil':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.ceil'),
          None,
...
'trunc':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.trunc'),
          None,
...
'fabs':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.fabs'),
          None,
...
'floor':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.floor'),
          None,
...
'rint':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.rint'),
          None,
...
'arctan2':
    Ufunc(2, 1, None,
          docstrings.get('labugr.np.core.umath.arctan2'),
          None,
...
'remainder':
    Ufunc(2, 1, None,
          docstrings.get('labugr.np.core.umath.remainder'),
          None,
          TD(intflt),
...
'divmod':
    Ufunc(2, 2, None,
          docstrings.get('labugr.np.core.umath.divmod'),
          None,
          TD(intflt),
...
'hypot':
    Ufunc(2, 1, Zero,
          docstrings.get('labugr.np.core.umath.hypot'),
          None,
...
'isnan':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.isnan'),
          None,
          TD(inexact, out='?'),
          ),
'isnat':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.isnat'),
          'PyUFunc_IsNaTTypeResolver',
          TD(times, out='?'),
          ),
'isinf':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.isinf'),
          None,
          TD(inexact, out='?'),
          ),
'isfinite':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.isfinite'),
          None,
          TD(inexact, out='?'),
          ),
'signbit':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.signbit'),
          None,
          TD(flts, out='?'),
          ),
'copysign':
    Ufunc(2, 1, None,
          docstrings.get('labugr.np.core.umath.copysign'),
          None,
          TD(flts),
          ),
'nextafter':
    Ufunc(2, 1, None,
          docstrings.get('labugr.np.core.umath.nextafter'),
          None,
          TD(flts),
          ),
'spacing':
    Ufunc(1, 1, None,
          docstrings.get('labugr.np.core.umath.spacing'),
          None,
          TD(flts),
          ),
'modf':
    Ufunc(1, 2, None,
          docstrings.get('labugr.np.core.umath.modf'),
          None,
          TD(flts),
          ),
'ldexp' :
    Ufunc(2, 1, None,
          docstrings.get('labugr.np.core.umath.ldexp'),
          None,
...
'frexp' :
    Ufunc(1, 2, None,
          docstrings.get('labugr.np.core.umath.frexp'),
          None,
