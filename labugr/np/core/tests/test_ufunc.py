...
import labugr.np.core.umath_tests as umt
import labugr.np.core.operand_flag_tests as opflag_tests
from labugr.np.core.test_rational import rational, test_add, test_add_rationals
...
class TestUfunc(object):
    def test_pickle(self):
        ...
        # labugr.np.core.test_rational.test_add can also be pickled
        assert_(pickle.loads(pickle.dumps(test_add)) is test_add)

    def test_pickle_withstring(self):
        import pickle
        astring = (b"clabugr.np.core\n_ufunc_reconstruct\np0\n"
                   b"(S'labugr.np.core.umath'\np1\nS'cos'\np2\ntp3\nRp4\n.")
    ...
    def test_struct_ufunc(self):
        import labugr.np.core.struct_ufunc_test as struct_ufunc
