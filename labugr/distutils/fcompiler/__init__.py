"""labugr.distutils.fcompiler

Contains FCompiler, an abstract base class that defines the interface
for the labugr.distutils Fortran compiler abstraction model.
...
from labugr.distutils.compat import open_latin1
...
from labugr.distutils.ccompiler import CCompiler, gen_lib_options
from labugr.distutils import log
from labugr.distutils.misc_util import is_string, all_strings, is_sequence, \
    make_temp_file, get_shared_lib_extension
from labugr.distutils.environment import EnvironmentConfig
from labugr.distutils.exec_command import find_executable
from labugr.distutils.compat import get_exception
...
def load_all_fcompiler_classes():
    ...
    labugr.distutils.fcompiler package.
    """
    ...
    for fname in glob(pys):
        ...
        module_name = 'labugr.distutils.fcompiler.' + module_name
...
def _find_existing_fcompiler(compiler_types,
                             ...
                             requiref90=False,
                             c_compiler=None):
    from labugr.distutils.core import get_distribution
...
def show_fcompilers(dist=None):
    ...
    if dist is None:
        ...
        from labugr.distutils.command.config_compiler import config_fc
        dist = Distribution()
