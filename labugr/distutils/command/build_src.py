...
from labugr.distutils.misc_util import (
    fortran_ext_match, appendpath, is_string, is_sequence, get_cmd
    )
from labugr.distutils.from_template import process_file as process_f_file
from labugr.distutils.conv_template import process_file as process_c_file
...
class build_src(build_ext.build_ext):
    ...
    def build_data_files_sources(self):
        ...
        from labugr.distutils.misc_util import get_data_files
        new_data_files = []
