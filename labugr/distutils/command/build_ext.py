...
from labugr.distutils.system_info import combine_paths
from labugr.distutils.misc_util import filter_sources, has_f_sources, \
     has_cxx_sources, get_ext_source_files, \
     get_numpy_include_dirs, is_sequence, get_build_architecture, \
     msvc_version
from labugr.distutils.command.config_compiler import show_fortran_compilers
...
class build_ext (old_build_ext):
    ...
    def run(self):
        ...
        from labugr.distutils.fcompiler import new_fcompiler
