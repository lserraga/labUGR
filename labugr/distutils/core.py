...
from labugr.distutils.extension import Extension
from labugr.distutils.numpy_distribution import NumpyDistribution
from labugr.distutils.command import config, config_compiler, \
     build, build_py, build_ext, build_clib, build_src, build_scripts, \
     sdist, install_data, install_headers, install, bdist_rpm, \
     install_clib
from labugr.distutils.misc_util import get_data_files, is_sequence, is_string
...
if have_setuptools:
    ...
    from labugr.distutils.command import develop, egg_info
