...
from labugr.distutils.exec_command import (
    find_executable, exec_command, get_pythonexe)
from labugr.distutils.misc_util import (is_sequence, is_string,
                                       get_shared_lib_extension)
from labugr.distutils.command.config import config as cmd_config
...
class NumericNotFoundError(NotFoundError):
    """
    Numeric (http://www.labugr.org/) module not found.
...
class system_info(object):
    ...
    def get_info(self, notfound_action=0):
        """ Return a dictonary with items that are compatible
            with labugr.distutils.setup keyword arguments.
        """
        flag = 0
...
class numerix_info(system_info):
    ...
    def calc_info(self):
        ...
        # If all the above fail, default to labugr.
        if which[0] is None:
