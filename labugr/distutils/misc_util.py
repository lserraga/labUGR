...
from labugr.distutils.compat import basestring
from labugr.distutils.compat import npy_load_module
...
class Configuration(object):
    ...
    def __init__(self,
        ...
        package_path -- directory of package. Will be computed by magic from the
                        ...
                        Ex.: the directory where labugr.distutils is
    ...
    def add_extension(self,name,sources,**kw):
        ...
        from labugr.distutils.core import Extension
    ...
    def get_config_cmd(self):
        """
        Returns the labugr.distutils config command instance.
        """
        cmd = get_cmd('config')
...
def get_npy_pkg_dir():
    ...
    import labugr
    d = os.path.join(os.path.dirname(labugr.__file__),
...
def get_pkg_info(pkgname, dirs=None):
    ...
    """
    from labugr.distutils.npy_pkg_config import read_config
...
def get_info(pkgname, dirs=None):
    ...
    """
    from labugr.distutils.npy_pkg_config import parse_flags
...
def generate_config_py(target):
    ...
    """
    from labugr.distutils.system_info import system_info
