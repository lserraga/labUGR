...
from labugr.testing import assert_, run_module_suite
...
class TestG77Versions(object):
    def test_g77_version(self):
        fc = labugr.distutils.fcompiler.new_fcompiler(compiler='gnu')
...
class TestGFortranVersions(object):
    def test_gfortran_version(self):
        fc = labugr.distutils.fcompiler.new_fcompiler(compiler='gnu95')
