...
import labugr.distutils.fcompiler
from labugr.testing import run_module_suite, assert_
...
class TestIntelFCompilerVersions(object):
    def test_32bit_version(self):
        fc = labugr.distutils.fcompiler.new_fcompiler(compiler='intel')
...
class TestIntelEM64TFCompilerVersions(object):
    def test_64bit_version(self):
        fc = labugr.distutils.fcompiler.new_fcompiler(compiler='intelem')
